...
<head>
 ...
 <title>Sistem Informasi Akuntansi Bengkel Abeck Jaya Motor</title>
...
<body class="bg-gradient-dark">
 ...
 <h1 class="h4 text-gray-900 mb4">Sistem Informasi Akuntansi<br>Bengkel Abeck Jaya Motor<br>
 <br><img src="{{ asset('asset/img/ajm_logo.png')}}" width="160"></h1>
 </div>
